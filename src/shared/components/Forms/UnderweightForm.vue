...
<template>
  <form class="grid grid-cols-1 lg:grid-cols-2 w-full gap-4 md:gap-8 items-end" @submit="submitAction">
    <p class="underline font-medium text-2xl md:col-span-2">Underweight Form</p>
    <MazPicker
    ...
    <div class="flex flex-col gap-1">
      <p class="font-semibold cursor-pointer">Have you ever been on a diet to lose weight?</p>
      <MazRadioButtons
          v-model="registrationStore.onDiet"
          :options="dietOptions"
          required
      />
    </div>
